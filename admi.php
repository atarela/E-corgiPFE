...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li>
								<a href="home-03.php">Page client</a>
							</li>
							...
							<li>
                                <a href="#">Mon Compte</a>
                                <ul class="sub-menu">
									<li><a href='admi.html'>Administrateur</a></li>
									<li><a href='vendeur.html'>Interne</a></li>
								</ul>
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				...
				<div class="sidebar-gallery w-full">
					...
					<p class="stext-108 cl6 p-t-27">
						...
						Dites OUI, mais pas pour la vie, grâce à nos services de location, adoptez des animaux de compagnie de façon éphémère.<br>
	...
	<ul>
	<li>
		<a href="form_choix.php" class="flex-c-m stext-101 cl0 size-101 bg10 bor1 hov-btn2 p-lr-15 trans-04">Ajouter un produit</a>
	</li>
	<br>
	<li>
		<a href="supp-produit.html" class="flex-c-m stext-101 cl0 size-101 bg10 bor1 hov-btn2 p-lr-15 trans-04">Supprimer un produit</a>
	</li>
	<br>
	<li>
		<a href="ajout-vendeur.html" class="flex-c-m stext-101 cl0 size-101 bg10 bor1 hov-btn2 p-lr-15 trans-04">Ajouter un Cliente</a>
	</li>
	<br>
	<li>
		<a href="supp-vendeur.html" class="flex-c-m stext-101 cl0 size-101 bg10 bor1 hov-btn2 p-lr-15 trans-04">Supprimer un client</a>
	</li>
	</ul>
			</div>
	</section>
