...
$erreur = "";
      ...
      if($origine == "") {$erreur .= "Le champ genre du pays d'origine est vide. <br>";}
...
if (isset($_POST['additem'])) { 
    if ($db_found) {
                      ...
                      ///fin id  
                      $sql2 = "INSERT INTO accessoires(id, categorie, origine)
                      VALUES('$id', '$categorie', '$origine')";
...
<p>Votre accessoire est bien ajoute et votre session est fermee.
