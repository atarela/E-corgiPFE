...
if (isset($_POST['additem'])) { 
    if ($db_found) {
                     ...
                     $sql2 = "INSERT INTO alimentation(id, categorie,poid)
                      VALUES('$id', '$categorie','$poid')";
...
<p>Votre article alimentaire est bien ajoute et votre session est fermee.
<br>Reviner a la page <a href="home-03.php">Accueil</a> pour voir votre article
</p>