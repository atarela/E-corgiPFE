					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
                                <a href="#">Mon Compte</a>
                                <ul class="sub-menu">
									<li><a href='admi.php'>Administrateur</a></li>
									<li><a href='vendeur.php'>Interne</a></li>
								</ul>
			...
			<div class="row">
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w layer-slick1 animated bounceIn " data-appear="fadeInDown" data-delay="2000">
						...
						<a href="admi.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="vendeur.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Je suis un inetrne
								</span>
